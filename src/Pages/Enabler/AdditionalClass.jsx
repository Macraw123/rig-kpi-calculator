...
import { ADDITIONAL_CLASS_TEMPLATE } from "../../Helpers/StaticLinks";
...
const AdditionalClass = (props) => {
  ...
  const uploadFirebase = () => {
    ...
    const fileRef = ref(
      storage,
      `/data/${currentAssistant}/${currentSemester}/AdditionalClass.xlsx`
    );
    ...
    <Container className="py-5">
      <Row>
        ...
        <Col sm={3} className="d-flex justify-content-end">
          <Button variant="secondary" href={ADDITIONAL_CLASS_TEMPLATE}>
            Download Template
          </Button>
        </Col>
      </Row>
